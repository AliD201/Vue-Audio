...
<fragment>
  <!-- Registration Form -->
    ...
    <!-- Age -->
    <div class="mb-3">
        <label name="email" class="inline-block mb-2">Age</label>
    ...
    <!-- TOS -->
    <div class="mb-3 pl-6">
        <vee-field name="tos" value="1" :validateOnInput="true"
...
export default {
  ...
  data() {
    return {
      schema: {
        ...
        age: 'required|minVal:18|maxVal:120|numeric',
  ...
  methods: {
    ...
    async register(values) {
      ...
      this.reg_alert_msg = 'Your account has been created succefully.';
